import 'package:delivery_man_app/src/models/social_network_enum.dart';
            ...
            children: [
              ...
              InkWell(
                onTap: loading
                    ? () {}
                    : () {
                        Navigator.of(context).pushNamed('/BasicSignup');
                      },
                child: SizedBox(
                  height: 50,
                  child: Row(
                    ...
                    children: [
                      Text(
                        AppLocalizations.of(context)!.registerAsCourier,
                        style: poppinsRegular.copyWith(
                            color: Theme.of(context).primaryColor),
                      )
                    ],
